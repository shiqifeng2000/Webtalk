...
impl NalUnitType {
    pub fn parse_header(first_byte: u8) -> Self {
        // let first_byte = data[0];
        // let forbidden_zero_bit = ((first_byte & 0x80) >> 7) == 1; // 0x80 = 0b10000000
        // let ref_idc = (first_byte & 0x60) >> 5; // 0x60 = 0b01100000
        // 0x1F = 0b00011111
        NalUnitType::from(first_byte & 0x1F)
    }
}
