...
pub trait BitRead {
    ...
    fn read_u64(&mut self, bit_count: u32, name: &'static str) -> Result<u64, BitReaderError>;
...
mod tests {
    ...
    //     use crate::parser::rbsp::{BitRead, BitReader};
    ...
    // #[test]
    // fn read_ue_overflow() {
    //     use crate::parser::rbsp::{BitRead, BitReader, BitReaderError};
